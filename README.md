...
Inline-бот для Telegram, который позволяет отправлять ролики из **TikTok**, **Instagram** и **YouTube** напрямую в личные сообщения **в виде видео**, без открытия встроенного браузера Telegram.

## 🚀 Возможности

* 📥 Приём ссылок на ролики TikTok, Instagram и YouTube
...
DOMAIN=Домен к которому будет обращаться Телеглрам для прокси запроса Ютуб видео
```
